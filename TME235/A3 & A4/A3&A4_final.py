...
plt.figure()
plt.plot(a1h1_r_vals, a1h1_sigma_rr_vals, color='brown', alpha=0.75, label=fr'normalized values, a: {1}, h: {1}')
plt.plot(a1h2_r_vals, a1h2_sigma_rr_vals, color='brown', alpha=0.75, linestyle='--', label=fr'normalized values, a: {1}, h: {0.5}')
plt.plot(a2h1_r_vals, a2h1_sigma_rr_vals, color='brown', alpha=0.75, linestyle=':', label=fr'normalized values, a: {0.5}, h: {1}')
plt.title('Radial stress')
plt.xlabel('r [m]')
plt.ylabel('sigma [Pa]')
