...
def task_2a(T1, M1, p1, D, fbar, gamma, R):
    ...
    M2 = interpolation(3.18012e+00,3.60000e-01, 2.70545e+00, 3.80000e-01, frac_4fLstar2_D)
    print(f'M2: {M2:.2f}')
...
def task_2b(T1, M1, p1, D, fbar, gamma, R):
    ...
    frac_4fLstar1_D = 1.45333e+01 # from A.4, M1 = 2.0
    Lstar1 = frac_4fLstar1_D * D / (4 * fbar)
    print(f'Lstar1: {Lstar1:.2f}')
...
task_2b(T1_2b, M1_2b, p1_2b, D_2b, fbar_2a, gamma_2a, R_2a)
